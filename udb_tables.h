...
static const hatch_ref g_hatch_refs[] =
{
    ...
    {19, "STEIGER, Brad & WHRITENOUR, Joan: FLYING SAUCERS ARE HOSTILE; Award Books PB 1967. 75 cents."},
    ...
    {33, "EMENEGGER, Robert: UFOS PAST PRESENT & FUTURE; Ballentine Books 1974."},
    ...
    {36, "LINDEMANN, Michael (ed.): UFOs and the ALIEN PRESENCE - Six Viewpoints; 2020 Group, Santa Barbara, CA 1991. 233pp."},
    {37, "CONDON, Dr. Edward: SCIENTIFIC STUDY of UFO..etc; Bantam 1969. 965pp. $1.95"},
    ...
    {59, "SCIENCE & MECHANICS (eds.) OFFICIAL GUIDE to UFOS; Ace Books, NY. 1968."},
    ...
    {66, "SAGAN/PAGE:UFOS a SCIENTIFIC DEBATE: Cornell Univ. Press, Ithaca, NY 1972"},
    {67, "BOWEN, Charles (ed.) The HUMANOIDS: HB Henry Regnery, Chicago 1969. 256pp. PB 1977 Futura, London"},
    {68, "STEIGER, Brad: STRANGERS from the SKIES; Award Books, NY 1966. 60 cents."},
    {69, "BLUM, Ralph & Judy: BEYOND EARTH: Mans Contact with UFOs Bantam, NY 1974"},
    {70, "OLSEN, Thomas: REFERENCE for OUTSTANDING UFO SIGHTINGS REPORTS. 1966 UFO Information Retrieval Center, Riderwood, MD 21139."},
    {71, "SACHS, Margaret: CELESTIAL PASSENGERS - UFOS and SPACE TRAVEL; Penguin Books, 1977."},
    ...
    {79, "RODEGHIER, Mark/CUFOS: UFO REPORTS INVOLVING VEHICLE INTERFERENCE; CUFOS 1979. Available as CUFOS UFO Archive #1 CD-ROM. $18. http://www.cufos.org/Pubform.pdf"},
    ...
    {83, "FOWLER, Raymond E.: UFOS, INTERPLANETARY VISITORS; Prentice Hall & Bantam Books, NY 1979. 346pp."},
    {84, "HOBANA Ion & WEVERBERGH,Julien:  UFOS from BEHIND the  IRON CURTAIN; Bantam Books,1975. 308pp."},
    ...
    {100, "STORY, Ronald (ed.) : ENCYLOPEDIA of UFOS: Doubleday, Garden City, NY 1980"},
    ...
    {109, "LORENZEN, Coral & Jim: UFOs OVER THE AMERICAS; Signet Books, NY 1968. 243p."},
    ...
    {119, "ADLER, Bill (ed.): LETTERS to the AIR FORCE on UFOs; Dell Paperbacks 1967; 50 cents."},
    ...
    {128, "GROSS, Loren: UFOS a HISTORY 1896. Self published 1974, 87"},
    {129, "GROSS, Loren: CHARLES FORT & UFOS. Self published, 1976"},
    {130, "GROSS, Loren: UFO's a HISTORY 1946 The Ghost Rockets. 1972,82,88."},
    {131, "GROSS, Loren: UFOS a HISTORY 1947: 1988 book and recent Supplements."},
    {132, "GROSS, Loren: UFOS a HISTORY 1948: 2 books: 1988 & 2000 Supplement."},
    {133, "GROSS, Loren: UFOS a HISTORY 1949: 3 books: 1988 & 2000 2001 Supplements."},
    {134, "GROSS, Loren: UFOs a HISTORY-1950 (4+books) 1989+2000  Self published."},
    {135, "GROSS, Loren: UFOS a HISTORY 1951 (2 booklets) Self published."},
    {136, "GROSS, Loren: UFOs a HISTORY-1952 (12 booklets) Self published."},
    {137, "GROSS, Loren: UFOs a HISTORY-1953 (6 booklets) Self published."},
    {138, "GROSS, Loren: UFOs a HISTORY-1954 (5 booklets) 1994 (2nd edition)"},
    {139, "GROSS, Loren: UFOs a HISTORY-1955 (3 booklets) Self published."},
    {140, "GROSS, Loren: UFOs a HISTORY-1956 (3 booklets) 1994 Self published."},
    {141, "GROSS, Loren: UFOs a HISTORY-1957 (19 booklets) Self published."},
    {142, "GROSS, Loren: UFOs a HISTORY-1958 (7 booklets) 1998/03 Self published."},
    {143, "GROSS, Loren: UFOs a HISTORY-1959 (4 booklets) 1999/00 Self published."},
    {144, "to be assigned. ]"},
    ...
    {151, "KLOIAN, Richard: UFOs in the New York TIMES, 1947-1987 1994 Document Research Services, Berkeley, CA"},
    ...
    {165, "REHN, K. Gosta: UFOs HERE and NOW; Translated/Swedish Patricia Crompton: London; Abelard 1974"},
    {166, "McWAYNE, Glenn & GRAHAM, David: The NEW UFO SIGHTINGS; Warner PB 1974 $1.25"},
    {167, "HIND, Cynthia: UFOS, AFRICAN ENCOUNTERS; Gemini Books, Salisbury, Zimbabwe 1982. 236pp"},
    {168, "VESCO, Renato: INTERCEPT but DON'T SHOOT; transl. from Italian. Goofy."},
    {169, "RANDLES, Jenny & Warrington, P.: SCIENCE and the UFOS; Basil Blackwell, NY 1985"},
    ...
    {177, "Von LUDVIGER, Illobrand ed. UFOs-SEUGEN UND ZEICHEN. Berlin 1995 edition q-Verlags GmbH ISBN 3-86124-300-8."},
    ...
    {188, "TEETS, Bob: WEST VIRGINIA UFOs; Headline Books, PO Box  52, Terra Alta, WV 1995 213pp."},
    ...
    {198, "MANEY, Charles & HALL, Richard: The CHALLENGE OF UFOS; NICAP, Washington, DC. 1961"},
    {199, "RANDLES, Jenny & WARRINGTON, Peter (eds): UFOs a BRITISH PERSPECTIVE; Robert Hale, London 1979."},
    ...
    {204, "SOULE, Gardner: UFOs & IFOs - A Factual Report..; Putnam's Sons, NY. 1968?"},
    ...
    {208, "DONG, Paul: UFOs Over MODERN CHINA. 1983 UFO Photo Archives; P. O. Box 17206; Tucson, AZ 85710."},
    ...
    {211, "GREEN, Gabriel: LETS FACE THE FACTS ABOUT UFOs. Popular Library, NY 1967. [JMC]"},
    ...
    {222, "GRANCHI, Irene: UFOs and ABDUCTIONS in BRAZIL: Horus House Press, Madison, WI: 1992 (English translation 1994) ISBN 1-881852-09-1"},
    ...
    {228, "ERSKINE, Allen Louis: THEY ARE THEY WATCHING US. Belmont Tower Books, NY 1967. 95 cents."},
    ...
    {247, "[ to be assigned ]"},
    {248, "[ to be assigned ]"},
    {249, "CLARK, Jerome: High Strangeness: UFOs from 1960 through 1979. The UFO ENCYCLOPEDIA Volume 3. 1996 Omnigraphics Inc Detroit, MI ISBN 1-55888-742-3"},
    {250, "[ to be assigned ]"},
...
static const hatch_ref g_hatch_refs_96[] =
{
    ...
    { 121, "UFOs over New England Website ( Select by state ) http://www.geocities.com/Area51/Nova/8874/ufomenu.html" },
...
static const hatch_ref g_hatch_refs_98[] =
{
    ...
    { 43, "BENDER, Albert K.: FLYING SAUCERS and the THREE MEN. 1962 & 1968 Paperback Library, NY. Foreward/Gray Barker. 160 pp. 50 cents." },
    ...
    { 72, "WHITE, Dale: IS SOMETHING UP THERE?; Doubleday 1968 & Scholastic PB 1969. 60 cents." },
...
static const char* g_pHatch_flag_descs[64] =
{
    ...
    "**SIG**: Signals/responses to/from/between UFOs/occupants/observers",
...
static const hatch_abbrev g_hatch_abbreviations[] =
{
    ...
    { "OCT",                                        "October" },
    { "OCT.",                                       "October" },
    { "ODR",                                        "odor or smell (associated with UFOs)" },
    { "OFC",                                        "Officer" },
    { "OFCR",                                       "Officer" },
    { "OFCRS",                                      "Officers" },
    { "OFFCR",                                      "Officer" },
    ...
    { "SHT",                                        "short" },
    { "SIGNLS",                                     "signals" },
    { "SIGS",                                       "signal(s) of any type involving UFOs\aliens" },
    { "SILENC",                                     "silence" },
    { "SLC",                                        "Salt Lake" },
    { "SLITE",                                      "searchlight" },
    { "SLNT",                                       "silent" },
